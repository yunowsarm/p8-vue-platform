        ...
        if (task.forecastBeginDate && task.start_date) {
          ...
          if (ed !== fe) {
            if (ganttObject.hasChild(task.id)) {
              return (
                '<div style="color:' +
                GanttResolveObject.forecastColor +
                ';font-weight:bold;">' +
                GanttResolveObject.dateToStr(ganttObject.date.add(task.forecastBeginDate, 0, 'day'), null, ganttObject) +
                '</div>'
              )
            } else {
          ...
          if (ed !== fe) {
            if (ganttObject.hasChild(task.id)) {
              return (
                ...
                GanttResolveObject.forecastColor +
                ';font-weight:bold;">' +
                GanttResolveObject.dateToStr(ganttObject.date.add(task.forecastEndDate, 0, 'day'), null, ganttObject) +
                '</div>'
              )
            } else {
