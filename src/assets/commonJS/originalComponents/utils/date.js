export default {
  ...
  nextMonth(date) {
    ...
    return month === 11 ? this.changeYearMonthAndClampDate(date, year + 1, 0) : this.changeYearMonthAndClampDate(date, year, month + 1)
  },

  prevMonth(date) {
    const year = date.getFullYear()
    const month = date.getMonth()
    return month === 0 ? this.changeYearMonthAndClampDate(date, year - 1, 11) : this.changeYearMonthAndClampDate(date, year, month - 1)
  },
