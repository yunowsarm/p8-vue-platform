...
export default {
  bind(el, binding, vnode, oldVnode) {
    ...
    let moveDown = e => {
      const path = e.path || (e.composedPath && e.composedPath()) || composedPath(e)
      if (path) {
    ...
    dragDom.onmousemove = function(e) {
      ...
      dragDom.onmousedown = e => {
        ...
        if (
          ...
          (clientX > EloffsetLeft && clientX < EloffsetLeft + 10) ||
          (clientX > EloffsetLeft + elW - 10 && clientX < EloffsetLeft + elW) ||
