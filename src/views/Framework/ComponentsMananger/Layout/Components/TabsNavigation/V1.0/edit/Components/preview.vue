...
import { P8Dialog as CommonDialog, P8ListLayout as ListLayout } from 'p8-components-ui'
export default {
  ...
  methods: {
    ...
    //   res.forEach(el => {
    //     data.push({name: el[this.tabsParmar.optionLabelCol],targetUrl:el[this.tabsParmar.optionUrl],id: el.ID})
    //   })
    //   return data
    // }
  }
