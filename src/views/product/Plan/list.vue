...
import { P8NormalLayoutV1 as NormalLayout, P8Tree as CommonTree, P8Dialog as CommonDialog, P8Table as CommonTable, P8Button as CommonButton, P8Drawer as CommonDrawer, P8MenuLayout as MenuLayout  } from 'p8-components-ui'
  ...
  created() {
    ...
    if (rootRouter && rootRouter.length > 0) {
      ...
      querySubRoute(rootRouter);
       this.thirdMenuData = thirdMenu.children;
    }
  },
  watch: {
    $route: {
