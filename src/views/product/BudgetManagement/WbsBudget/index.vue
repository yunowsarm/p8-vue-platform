...
export default {
  ...
  created () {
    ...
    console.log(this.$isMobile, '三级菜单参数')
...
<template>
  <div style="height: 100%">
    <normal-layout v-if="!$isMobile"
                   layoutCode="wbsBudget"
                   :split-default-left-width="30"
                   :header-visible="false"
                   :split-layout="true">
      <template #west>
        <common-table ref="taskTable"
                      :pagination="false"
      ...
      <template #center>
        <div class="main-table">
          <vxe-table border
            ...
            <vxe-column v-if="parentRoute !== 'BudgetManagement'"
                        field="actualAmount"
                        title="实际金额">
        ...
        <div v-if="parentRoute === 'BudgetManagement'"
             class="button-area">
    ...
    <div style="height: 100%; display: flex; flex-direction: row;overflow: auto;"
         v-if="$isMobile">
