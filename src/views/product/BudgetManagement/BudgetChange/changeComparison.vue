  ...
  <div class="main-area">
    <vxe-table border :data="tableData" :tableConfig="tableConfig" :tree-config="treeConfig" align="center" height="100%">
      ...
      <vxe-colgroup :title="tableData[0].initiateTime + '预算变更记录'">
        <vxe-column field="amountOld" title="变更前（元）"></vxe-column>
        <vxe-column field="amount" title="变更后（元）"></vxe-column>
      </vxe-colgroup>
      <vxe-colgroup :title="tableData[0].initiateTime1 + '预算变更记录'">
        <vxe-column field="amountOld1" title="变更前（元）"></vxe-column>
        <vxe-column field="amount1" title="变更后（元）"></vxe-column>
      </vxe-colgroup>
