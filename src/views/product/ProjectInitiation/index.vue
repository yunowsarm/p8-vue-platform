<template>
  <list-layout :header-visible="false">
    <template #center>
      <tabs-navigation-preview ref="tabsNavigation" :layout-config="layoutConfig" :data-view-id="dataViewId" @tabClick="tabClick" :prop-param="propParam"></tabs-navigation-preview>
    </template>
  </list-layout>
</template>
<script>
