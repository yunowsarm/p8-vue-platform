...
const benefitPolicySearchApi = {
  tobBenefitPolicySearch: [
    {
      name: 'policyList',
      method: 'POST',
      path: '/gov-policy/zhengce/qiye/trssearch/search/all',
      mockPath: '/gov-policy/zhengce/qiye/trssearch/search/all',
      sameOrigin: true,
      desc: '惠企政策查询'
    },
    {
      ...
      method: 'POST',
      path: '/gov-policy/zhengce/qiye/trssearch/search/unscramble',
      mockPath: '/gov-policy/zhengce/qiye/trssearch/search/unscramble',
      sameOrigin: true,
      desc: '惠企政策解读查询'
    }
  ]
